	...
	,	getContext: function()
		{
			...
			for(var i=0;i<lines.length;i++){
				price_container_object={price:lines.models[i].get("rate"),price_formatted:lines.models[i].get("rate_formatted")};
				SC.Tools.updatePriceObject(price_container_object);
				subtotal+=price_container_object.price*lines.models[i].get("quantity");
			}
			...
			,	subtotalFormatted: !this.isLoading ? Utils.formatCurrency(subtotal) : ''
