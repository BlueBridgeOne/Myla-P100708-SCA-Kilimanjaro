...
define(
	'OrderWizard.Module.CartSummary', [
		'SC.Configuration', 'Wizard.Module', 'Backbone.CompositeView', 'Backbone.CollectionView', 'GlobalViews.FormatPaymentMethod.View', 'Cart.Promocode.List.View'

		, 'order_wizard_cart_summary.tpl', 'cart_summary_gift_certificate_cell.tpl'

		, 'underscore', 'Utils', 'Tools'
	],
	function (
		Configuration, WizardModule, BackboneCompositeView, BackboneCollectionView, GlobalViewsFormatPaymentMethodView, CartPromocodeListView

		, order_wizard_cart_summary_tpl, cart_summary_gift_certificate_cell_tpl
			...
			childViews: {
				'GiftCertificates': function () {
					return new BackboneCollectionView({
						collection: this.wizard.model.get('paymentmethods').where({
			...
			getContext: function getContext() {
				...
				return {
					...
					itemCountGreaterThan1: item_count > 1
						...
						,
					giftCertificates: model.get('paymentmethods').where({
							type: 'giftcertificate'
						}) || []
