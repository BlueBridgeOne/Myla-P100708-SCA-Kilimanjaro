			...
			<div class="cart-summary-subtotal">
				<p class="cart-summary-grid-float">
					<span class="cart-summary-amount-subtotal">
						...
						{{#if incTax}}
						<small class="summary-price-message">{{translate 'Inc VAT'}}</small>
						{{#if extraTax}}
						<small class="summary-price-message">{{translate 'This destination has additional taxes.'}}</small>
						{{/if}}
						{{else}}
<small class="summary-price-message">{{translate 'Ex tax &amp; duties'}}</small>
						{{/if}}
			...
			{{#unless areAllItemsPickupable}}
				...
				{{#if showTaxAndShipping}}
					<div class="cart-summary-shipping-cost-applied">
						{{#unless isDefaultShipping}}
