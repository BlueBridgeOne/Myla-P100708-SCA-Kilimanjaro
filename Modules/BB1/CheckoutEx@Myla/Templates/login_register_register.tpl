...
{{/unless}}
	...
	<div class="login-register-register-form-controls-group">
		<label class="login-register-register-form-label">
			...
			{{translate 'Sign me up for Myla promotional emails and offers'}}
		</label><br />
		<small><a href="/terms" data-touchpoint="home">{{translate 'Terms of Use'}}</a> & <a href="/privacy" data-touchpoint="home">{{translate 'Privacy Policy'}}</a></small>
	</div>
