...
define('ContactUs.View', [
    ...
    'ContactUs.Info.View','HeaderBar.Home.View'
], function(
    Backbone, BackboneFormView, contactUsTpl, MessageView, jQuery, _, Configuration, Tools, ContactUsInfoView,HeaderBarHome
) {
    'use strict';
