...
define(
    'ApplicationSkeleton.Layout', ['GlobalViews.Modal.View', 'HeaderBar.View', 'Footer.View', 'Backbone.CompositeView', 'GlobalViews.Breadcrumb.View', 'Tracker', 'HeaderBar.Home.View'

        , 'Backbone', 'underscore', 'jQuery'
    ],
    function (
        GlobalViewsModalView, HeaderView, FooterView, BackboneCompositeView, GlobalViewsBreadcrumbView, Tracker, HeaderBarHome
        ...
        return Backbone.View.extend({
            ...
            initialize: function (Application) {
                    ...
                    jQuery(window).on('resize', _.throttle(function () {
                        ...
                        if (SMT) {
                            //console.log("Running in SMT");

                            if (!self.addParallax) {
                                self.addParallax = true;
                                ...
                                $("[data-parallax]").each(function () {
                                    ...
                                    $(this).find(".PH_TEXT").append(" | <span style=\"color:#678c99;\">Parallax : " + parallax + "</span");
                                });
                        ...
                        var innerContent = $(".footer-categories-wrapper >ul");
                    ...
                    document.addEventListener("scroll",  function () {
                        ...
                        if (SMT) {
                            ...
                            SC.Tools.updateHeaderColors(self.$el);

                            var top = $(document).scrollTop();
                            if (window["lastTop"] == top) {
                                return;
                            }
                            self["lastTop"] = top;
                                ...
                                switch (parallax) {
                                    ...
                                    case "prodbanner":
                                        ...
                                        var speed = 200;
                                                ...
                                                var exit = top + vph;
                                                var give = 100;
                                                if (etop >= entry - give && etop <= exit + give) { //element is in viewport
                                        ...
                                        if (false) {
                                            ...
                                            if (speed < 0 || speed > 0) {
                                                ...
                                                if (etop >= entry - give && etop <= exit + give) { //element is in viewport
                                                    ...
                                                    $this.css("top", parseInt(pos * speed * 100) + "px");
