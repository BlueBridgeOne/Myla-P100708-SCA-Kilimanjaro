		...
		,	getPrice: function getPrice (quantity, selected_matrix_children)
			{
				...
				if (this.get('_comparePriceAgainst'))
				{
					//@class ItemPrice
					...
					result.price=result.price||result.compare_price;
					result.price_formatted=result.price_formatted||result.compare_price_formatted;
					
				}
// 				if(selected_matrix_children){
// console.log("result="+selected_matrix_children+" "+JSON.stringify(result));
// }
				return result;
			}
