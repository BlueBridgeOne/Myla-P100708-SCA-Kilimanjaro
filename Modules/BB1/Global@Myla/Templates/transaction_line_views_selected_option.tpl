...
<div class="transaction-line-views-selected-option" name="{{label}}">
	<p>
		<span class="transaction-line-views-selected-option-label">{{translate label}}: </span>
		<span class="transaction-line-views-selected-option-value">{{translate selectedValue.label}}</span>
	</p>
</div>
