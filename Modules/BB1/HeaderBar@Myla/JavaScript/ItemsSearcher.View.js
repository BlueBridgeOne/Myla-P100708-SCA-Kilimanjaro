	...
	)
{
	...
	,	defaultOptions: {
            ...
            placeholderLabel: _('Search on Myla.com...').translate()
	...
	,	initialize: function (options)
		{
			...
			this.options.componentId=this.options.componentId||"search-input";
			if(this.options.mobile&&this.options.componentId=="search-input"){
			this.options.componentId="header-search-input";
			}
