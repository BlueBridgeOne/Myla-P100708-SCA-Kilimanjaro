    ...
    <div class="site-search-content">
        <form class="site-search-content-form" method="GET" action="/search" data-action="search">
            <div class="site-search-content-input">
                <ul class="site-search-box">
                    <li>
				<div data-view="ItemsSeacher"></div>
            </li><li class="site-search-content-icon-container">
                <!--Search Icon -->
<svg class="site-search-input-icon" fill="currentColor" width="15px" height="15px" viewBox="0 0 15 15" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
