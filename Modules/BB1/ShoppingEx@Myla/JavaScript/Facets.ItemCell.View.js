	...
	)
{
	...
	,	getContext: function ()
		{
var bigItem =this.$el.closest(".CELL_BIGITEM").length>0; //A large image is required.
var imageSize='thumbnail';
if(bigItem){
	imageSize="main";
}
		var imageDetails=SC.Tools.getAllItemImages(this.model,this.model.get('colour'));
