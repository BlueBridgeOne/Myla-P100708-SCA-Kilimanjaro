	...
	,	url: function()
		{
			...
			//console.log(profile);
			//console.log("Can Preview: " + profile.get("canpreview"));



			if (profile.get('canpreview') == 'T') {
				url = url + "&custitem_bb1_mya_item_status=Live,Leaving,Preview";
			} else {
				url = url + "&custitem_bb1_mya_item_status=Live,Leaving";
			}
