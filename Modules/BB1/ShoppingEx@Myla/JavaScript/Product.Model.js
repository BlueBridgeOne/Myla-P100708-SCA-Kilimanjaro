	...
	)
{
	...
	var ProductModel = Backbone.Model.extend(
		...
		,	setOption: function setOption (option_cart_id, value)
			{
			console.log("model "+option_cart_id+" "+value);
				var self = this;
					...
					.then(function ()
					{
						...
						if (selected_option)
						{
							if (selected_value)
							{
								...
								self.set("header_"+option_cart_id, value);
								self.set("subheader_"+option_cart_id, value);
							}
							...
							else
							{
								...
								self.unset("header_"+option_cart_id);
								self.unset("subheader_"+option_cart_id);
							}
