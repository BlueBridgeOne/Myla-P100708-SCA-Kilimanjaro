...
if(price_container_object.compare_price){ //There is a sale price so work out % off.
	...
	//console.log("compare "+price_container_object.compare_price+" "+price_container_object.price);
	var diff=price_container_object.compare_price-price_container_object.price;
	
	sale=Math.round(100*(diff/price_container_object.compare_price));
	if(sale<1){
		sale=undefined;
	}else{
		saleClass="saleClass";
