...
define(
	...
	function (
		...
		return SCModel.extend({
			...
			,forceCurrency:function(){ //Didn't work but may need to make work in the future.
				// var bb1_sca_site = context.getSessionObject("bb1_sca_site");
				// if (bb1_sca_site) {
				// 	nlapiLogExecution("DEBUG","Force Shopper Currency for "+bb1_sca_site);
				// 	switch (bb1_sca_site) {
				// 		case "UK":
				// 			ModelsInit.session.setShopperCurrency(1);
				// 			break;
				// 		case "Europe":
				// 			ModelsInit.session.setShopperCurrency(4);
				// 			break;
				// 		default:
				// 			ModelsInit.session.setShopperCurrency(2);
				// 			break;
				// 	}
				// }
			}
